...
/// A chat that takes a question spoken into the microphone as well as a typed
/// one — and, from this step on, reads every answer out loud.
///
...
class _ChatPageState extends State<ChatPage> {
  ...
  /// Synthesizes [text] and starts playing it. Returns once playback has
  /// STARTED — the composer unlocks while the answer is still being read out.
