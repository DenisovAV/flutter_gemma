        ...
        actions: [
          PopupMenuButton<_Action>(
            ...
            itemBuilder: (context) => [
              ...
              // Only a downloaded model can be forgotten. A built-in one has
              // no file to free and no install record to remove, so offering
              // it would be a lie — `uninstallModel` would throw.
