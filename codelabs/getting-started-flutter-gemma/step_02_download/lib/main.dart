...
/// Placeholder for the next step, which puts a chat here.
class _ModelReady extends StatelessWidget {
  const _ModelReady({required this.model});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text(model.label)),
      body: const Center(
        child: Padding(
