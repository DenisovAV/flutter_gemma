...
2. **Understand the architecture:**
   ...
   - Native libs are downloaded by `flutter_gemma_litertlm/hook/build.dart` (the sole hook) at build time from the `native-v0.17.0-a` GitHub release; SHA256-verified and bundled by Native Assets
