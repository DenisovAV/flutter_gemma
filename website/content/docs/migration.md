...
dependencies:
  ...
  flutter_gemma_litertlm: ^1.7.2        # add if you run .litertlm models (also provides LiteRtEmbeddingBackend)
...
dependencies:
  ...
  flutter_gemma_litertlm: ^1.7.2     # now provides LiteRtEmbeddingBackend
```
