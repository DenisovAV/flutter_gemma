...
file decides. It applies to `.litertlm` on Android, iOS and desktop, not on web.
See [Troubleshooting → Wrong numbers on GPU](/docs/troubleshooting#wrong-numbers-on-gpu).
