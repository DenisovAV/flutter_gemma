...
data class RetrievalResult (
...
)
 {
  ...
  override fun equals(other: Any?): Boolean {
    if (other !is RetrievalResult) {
      return false
    }
    if (this === other) {
      return true
    }
    return PigeonInterfacePigeonUtils.deepEquals(toList(), other.toList())  }
...
data class DocumentWithEmbedding (
...
)
 {
  ...
  override fun equals(other: Any?): Boolean {
    if (other !is DocumentWithEmbedding) {
      return false
    }
    if (this === other) {
      return true
