...
void main() {
  ...
  setUpAll(() async {
    ...
    _testImage = File(_imgPath).existsSync()
        ? File(_imgPath).readAsBytesSync()
        : Uint8List(0);
    _testAudio = File(_audioPath).existsSync()
        ? File(_audioPath).readAsBytesSync()
        : Uint8List(0);
