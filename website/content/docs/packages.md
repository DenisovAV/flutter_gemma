...
| **`flutter_gemma_speech`** | On-device [speech](/docs/speech) — speech-to-text + text-to-speech (moonshine STT + Matcha TTS today) via the LiteRT C API + `dart:ffi`. | Native (no Web) |
