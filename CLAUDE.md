...
- **Current Version**: core `flutter_gemma` `1.10.0`, `flutter_gemma_rag_sqlite` `1.4.0`, `flutter_gemma_rag_qdrant` `1.3.1`; `flutter_gemma_litertlm` `1.8.1`, `flutter_gemma_mediapipe` `1.0.6`, `flutter_gemma_embeddings` `2.2.0`, `flutter_gemma_speech` `0.5.1`; `flutter_gemma_agent` `0.2.5`, `flutter_gemma_builtin_ai` `0.2.2`, `flutter_gemma_onnx` `0.4.0`; `genkit_flutter_gemma` `0.6.2`, `genkit_hybrid` `0.2.1`
