...
const _packageName = 'flutter_gemma_rag_qdrant';
...
///
/// upstream qdrant-edge natively supports `wal_options` in EdgeConfig (merged
/// via https://github.com/qdrant/qdrant/pull/9067). Vendored fork dropped;
/// built directly from crates.io.
///
...
const _bundles = [_qdrantEdgeBundle];
