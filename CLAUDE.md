...
- **Current Version**: core `flutter_gemma` `1.5.3`, `flutter_gemma_rag_sqlite` `1.1.0`, `flutter_gemma_rag_qdrant` `1.1.0`; `flutter_gemma_litertlm` `1.3.1`, `flutter_gemma_mediapipe` `1.0.4`, `flutter_gemma_embeddings` `1.0.4`, `flutter_gemma_speech` `0.4.2`; `flutter_gemma_agent` `0.2.0`, `flutter_gemma_builtin_ai` `0.1.0`
