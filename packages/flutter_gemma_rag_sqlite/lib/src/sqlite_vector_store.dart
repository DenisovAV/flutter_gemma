...
/// On-device RAG vector store using sqlite3 (dart:ffi) + an HNSW index.
/// Native platforms only; web uses [WebSqliteVectorStore]. Implements
/// flutter_gemma's [VectorStoreRepository].
