...
use crate::common::mmap::{MULTI_MMAP_IS_SUPPORTED, Madviseable as _};
use crate::common::universal_io::read::UniversalReadPipeline;
...
impl UniversalReadFileOps for MmapFile {
    ...
    fn exists(path: &Path) -> crate::common::universal_io::Result<bool> {
