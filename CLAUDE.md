...
- **Current Version**: core `flutter_gemma` `1.7.0`, `flutter_gemma_rag_sqlite` `1.3.1`, `flutter_gemma_rag_qdrant` `1.3.0`; `flutter_gemma_litertlm` `1.6.1`, `flutter_gemma_mediapipe` `1.0.5`, `flutter_gemma_embeddings` `2.0.0`, `flutter_gemma_speech` `0.4.3`; `flutter_gemma_agent` `0.2.5`, `flutter_gemma_builtin_ai` `0.2.1`, `flutter_gemma_onnx` `0.3.2`; `genkit_flutter_gemma` `0.5.0`, `genkit_hybrid` `0.2.0`
