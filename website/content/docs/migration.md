...
dependencies:
  ...
  flutter_gemma_litertlm: ^1.6.0        # add if you run .litertlm models (also provides LiteRtEmbeddingBackend)
...
dependencies:
  ...
  flutter_gemma_litertlm: ^1.6.0     # now provides LiteRtEmbeddingBackend
```
